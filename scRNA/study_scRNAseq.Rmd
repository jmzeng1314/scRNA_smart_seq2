...
这个包内置的是 Pollen et al. 2014 数据集，人类单细胞细胞，分成**4类**，分别是 pluripotent stem cells 分化而成的 neural progenitor cells (“NPC”) ，还有 “GW16” and “GW21” ，“GW21+3” 这种孕期细胞。 
...
301 samples, 地址为<https://hemberg-lab.github.io/scRNA.seq.datasets/human/tissues/>
...
很明显，他们可以有根据来进行分组，这里不再演示。 不过通常的文章并不会考虑如此多的细节
